...
const char *freebsd32_syscallnames[] = {
	...
	"#593",			/* 593 = reserved for local use */
	"#594",			/* 594 = reserved for local use */
	"#595",			/* 595 = reserved for local use */
	"#596",			/* 596 = reserved for local use */
	"#597",			/* 597 = reserved for local use */
	"#598",			/* 598 = reserved for local use */
	"#599",			/* 599 = reserved for local use */
	"osdb_exec",			/* 600 = osdb_exec */
	"freebsd32_osdb_prepare_v2",			/* 601 = freebsd32_osdb_prepare_v2 */
	"osdb_step",			/* 602 = osdb_step */
	"osdb_finalize",			/* 603 = osdb_finalize */
	"osdb_column_blob",			/* 604 = osdb_column_blob */
	"osdb_column_double",			/* 605 = osdb_column_double */
	"osdb_column_int",			/* 606 = osdb_column_int */
	"freebsd32_osdb_column_int64",			/* 607 = freebsd32_osdb_column_int64 */
	"osdb_column_text",			/* 608 = osdb_column_text */
	"osdb_column_text16",			/* 609 = osdb_column_text16 */
	"osdb_column_value",			/* 610 = osdb_column_value */
	"osdb_column_bytes",			/* 611 = osdb_column_bytes */
	"osdb_column_bytes16",			/* 612 = osdb_column_bytes16 */
	"osdb_column_type",			/* 613 = osdb_column_type */
	"osdb_column_count",			/* 614 = osdb_column_count */
	"osdb_column_name",			/* 615 = osdb_column_name */
	"osdb_sample",			/* 616 = osdb_sample */
	"osdb_vtable_open",			/* 617 = osdb_vtable_open */
	"osdb_vtable_close",			/* 618 = osdb_vtable_close */
	"osdb_vtable_filter",			/* 619 = osdb_vtable_filter */
	"osdb_vtable_next",			/* 620 = osdb_vtable_next */
	"osdb_vtable_eof",			/* 621 = osdb_vtable_eof */
	"freebsd32_osdb_vtable_column",			/* 622 = freebsd32_osdb_vtable_column */
	"osdb_vtable_column_ptr",			/* 623 = osdb_vtable_column_ptr */
	"osdb_vtable_rowid",			/* 624 = osdb_vtable_rowid */
	"osdb_snapshot",			/* 625 = osdb_snapshot */
	"osdb_snapshot_clear",			/* 626 = osdb_snapshot_clear */
};
