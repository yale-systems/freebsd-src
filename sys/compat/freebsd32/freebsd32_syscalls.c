...
const char *freebsd32_syscallnames[] = {
	...
	"osdb_snapshot_clear",			/* 617 = osdb_snapshot_clear */
	"osdb_vtable_create",			/* 618 = osdb_vtable_create */
	"osdb_vtable_connect",			/* 619 = osdb_vtable_connect */
	"osdb_vtable_bestindex",			/* 620 = osdb_vtable_bestindex */
	"osdb_vtable_disconnect",			/* 621 = osdb_vtable_disconnect */
