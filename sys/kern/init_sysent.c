...
struct sysent sysent[] = {
	...
	{ .sy_narg = AS(osdb_vtable_close_args), .sy_call = (sy_call_t *)sys_osdb_vtable_close, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 624 = osdb_vtable_close */
	{ .sy_narg = AS(osdb_vtable_filter_args), .sy_call = (sy_call_t *)sys_osdb_vtable_filter, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 625 = osdb_vtable_filter */
