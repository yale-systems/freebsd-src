...
struct sysent sysent[] = {
	...
	{ .sy_narg = AS(osdb_prepare_v2_args), .sy_call = (sy_call_t *)sys_osdb_prepare_v2, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 601 = osdb_prepare_v2 */
	...
	{ .sy_narg = AS(osdb_column_int64_args), .sy_call = (sy_call_t *)sys_osdb_column_int64, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 607 = osdb_column_int64 */
	...
	{ .sy_narg = AS(osdb_vtable_column_args), .sy_call = (sy_call_t *)sys_osdb_vtable_column, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 622 = osdb_vtable_column */
