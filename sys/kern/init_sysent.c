...
struct sysent sysent[] = {
	...
	{ .sy_narg = AS(osdb_prepare_v2_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 601 = osdb_prepare_v2 */
	...
	{ .sy_narg = AS(osdb_column_int64_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 607 = osdb_column_int64 */
	...
	{ .sy_narg = AS(osdb_vtable_filter_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 625 = osdb_vtable_filter */
	...
	{ .sy_narg = AS(osdb_vtable_update_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 630 = osdb_vtable_update */
