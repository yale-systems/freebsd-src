...
typedef int (__sys_osdb_snapshot_clear_t)(void);
typedef void (__sys_osdb_vtable_create_t)(void);
typedef void (__sys_osdb_vtable_connect_t)(void);
typedef void (__sys_osdb_vtable_bestindex_t)(int, void *);
...
int __sys_osdb_snapshot_clear(void);
void __sys_osdb_vtable_create(void);
void __sys_osdb_vtable_connect(void);
void __sys_osdb_vtable_bestindex(int cursor, void * pIdxInfo);
