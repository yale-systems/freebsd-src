...
typedef int (__sys_osdb_vtable_filter_t)(int);
...
typedef int (__sys_osdb_snapshot_t)(int, long long);
...
int __sys_osdb_vtable_filter(int cursor);
...
int __sys_osdb_snapshot(int flags, long long timestamp);
