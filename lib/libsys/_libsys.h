...
typedef int (__sys_osdb_finalize_t)(void*);
typedef int (__sys_osdb_column_blob_t)(void*, int, char *, int);
typedef int (__sys_osdb_column_double_t)(void*, int, double *);
typedef int (__sys_osdb_column_int_t)(void*, int, int *);
typedef int (__sys_osdb_column_int64_t)(void*, int, long *);
typedef int (__sys_osdb_column_text_t)(void*, int, char *, int);
typedef int (__sys_osdb_column_text16_t)(void*, int, char *, int);
typedef int (__sys_osdb_column_value_t)(void*, int, char *, int *);
typedef int (__sys_osdb_column_bytes_t)(void*, int, int *);
typedef int (__sys_osdb_column_bytes16_t)(void*, int, int *);
...
typedef int (__sys_osdb_vtable_filter_t)(int, const char *, int, int, struct dbsc_value *);
...
typedef int (__sys_osdb_vtable_rowid_t)(int, int64_t *);
...
int __sys_osdb_finalize(void* sqlite3_stmt);
int __sys_osdb_column_blob(void* sqlite3_stmt, int iCol, char * data, int len);
int __sys_osdb_column_double(void* sqlite3_stmt, int iCol, double * result);
int __sys_osdb_column_int(void* sqlite3_stmt, int iCol, int * result);
int __sys_osdb_column_int64(void* sqlite3_stmt, int iCol, long * result);
int __sys_osdb_column_text(void* sqlite3_stmt, int iCol, char * data, int len);
int __sys_osdb_column_text16(void* sqlite3_stmt, int iCol, char * data, int len);
int __sys_osdb_column_value(void* sqlite3_stmt, int iCol, char * data, int * reslen);
int __sys_osdb_column_bytes(void* sqlite3_stmt, int iCol, int * size);
int __sys_osdb_column_bytes16(void* sqlite3_stmt, int iCol, int * size);
...
int __sys_osdb_vtable_filter(int cursor, const char * filter, int len, int argc, struct dbsc_value * values);
...
int __sys_osdb_vtable_rowid(int cursor, int64_t * rowid);
